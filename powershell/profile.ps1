...
$my_scripts_dir = 'C:\CorePlatform\99. pwsh script'

if ([System.IO.Directory]::Exists($my_scripts_dir)) {
    foreach ($my_script in [System.IO.Directory]::GetFiles($my_scripts_dir, '*.ps1')) {
